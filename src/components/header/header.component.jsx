...
import { Cart, ChevronDown, UserIcon } from "../icons/icon.components";
...
export const Header = ({user}) => {
  ...
  return (
    <>
      <nav className="bg-white dark:bg-gray-800 antialiased relative z-50">
        <div className="max-w-screen-xl px-4 mx-auto 2xl:px-0 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-8">
              ...
              <ul className="hidden lg:flex items-center justify-start gap-6 md:gap-8 py-3 sm:justify-center [&>li>.active]:underline">
                <li>
                  <NavLink
                    to="/"
                    title=""
                    className="flex text-sm font-medium text-gray-900 hover:text-primary-700 dark:text-white dark:hover:text-primary-500 hover:underline"
                  >
                    Home
                  </NavLink>
                </li>
                ...
                <li className="shrink-0">
                  <NavLink
                    to="/privacy-policy"
                    title=""
                    className="text-sm font-medium text-gray-900 hover:text-primary-700 dark:text-white dark:hover:text-primary-500 hover:underline"
                  >
                    Privacy Policy
                  </NavLink>
                </li>
